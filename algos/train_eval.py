...
from algos import ensemble_sac_agent
...
from tf_agents.metrics import tf_metrics, tf_py_metric
  ...
  with tf.compat.v2.summary.record_if(
    ...
    if ensemble:
        ...
        for _ in range(n_critics):
          ...
          critic_optimizers.append(
            tf.keras.optimizers.Adam(learning_rate=critic_learning_rate))
    ...
    train_metrics = [
        ...
        tf_py_metric.TFPyMetric(
          metrics.AverageEarlyFailureMetric(buffer_size=num_eval_episodes,
